<template>
  <div class="mb-4">
    ...
    <nuxt-content :document="article" class="prose md:prose-lg lg:prose-xl" />
    <!-- <nuxt-content :document="article" class="prose md:prose-lg xl:prose-xl" /> -->
    <!-- <nuxt-content :document="article" class="prose prose-xl" /> -->
